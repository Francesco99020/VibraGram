...
-- USERS
INSERT INTO users (username, email, password_hash, full_name, gender, bio, profile_pic, is_public, is_admin) VALUES
('alice', 'alice@example.com', 'hashed_pw1', 'Alice Johnson', 'female', 'Love traveling and photography.', '/images/alice.jpg', true, true),
('bob', 'bob@example.com', 'hashed_pw2', 'Bob Smith', 'male', 'Coffee addict. Developer.', '/images/bob.jpg', false, false),
('carol', 'carol@example.com', 'hashed_pw3', 'Carol White', 'male', 'Music is life.', '/images/carol.jpg', true, false),
('dave', 'dave@example.com', 'hashed_pw4', 'Dave Brown', 'male', 'Foodie & Gamer.', '/images/dave.jpg', true, false);
