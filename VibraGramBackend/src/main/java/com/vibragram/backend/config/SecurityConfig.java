package com.vibragram.backend.config;
...
import com.vibragram.backend.security.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    // AuthenticationManager bean (needed if you use username/password login somewhere)
    @Bean
